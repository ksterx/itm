...
- [x] **Phase 2-B v6-α**（2026-05-16）: AMI 17 meetings (8.6h) で再学習 → **Overall 0.677** (baseline 0.586 超え、calibration 改善)、ただし AUC は 0.535 で v4 0.566 から微悪化
- [ ] **Phase 2-B v7**: discrimination 強化 (va_classifier 解凍 / shift_head 深層化 / AMI 50h+)
